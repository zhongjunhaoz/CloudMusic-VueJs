  ...
  <div>
    ...
    <div class="play" v-show="isShow">
      ...
      <div class="palyDetail-picBox">
        <img :src="pic" :class="isplay ? 'playDetail-cover' : 'playDetail-cover-pause'"  @click="showLyric" v-show="isShowLyric"/>
        <span v-show="!isShowLyric" @click="showLyric" class="playDetail-lyric">暂无歌词，请欣赏</span>
      </div>
      <div class="playDetail-icon">
        <div class="icon icon-changeSong"><img class="detail-ChagngeSong" src="../assets/img/lastSong.png"/></div>
        <i @click="musicPause" class="el-icon-video-pause icon" v-show="isplay"></i>
        <i @click="musicPlay" class="el-icon-video-play icon" v-show="!isplay"></i>
        <div class="icon icon-changeSong"><img class="detail-ChagngeSong" src="../assets/img/nextSong.png"/></div>
      </div>
